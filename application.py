...
from controller.controller import PaddlePosition
from controller.player_controller import PlayerController
from controller.basic_bot_controller import BasicBotController

class ControllerType(Enum):
    """Controller type to use for paddle."""
    PLAYER = 0                      #Player controller
    BASIC_BOT = 1                   #Bot controller with basic level


class Pong:
    """A Pong application."""

    def __init__(self, controller_1_type=ControllerType.PLAYER, controller_2_type=ControllerType.BASIC_BOT):
    ...
    def run(self):
        ...
        while self._is_running:
            ...
            self._controller_1.update(delta_time)
            self._controller_2.update(delta_time)
            self._current_game.update(delta_time)
